    ...
    <div className="min-h-screen" style={{ background: t.bg, color: t.text }}>
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-base" style={{ color: t.text }}>Logbook</span>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-6 space-y-5">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex-1 flex items-center gap-2 px-4 py-2.5 rounded-xl min-w-48"
            style={{ background: t.card, border: `1px solid ${t.border}` }}>
                ...
                <thead>
                  <tr style={{ borderBottom: `1px solid ${t.border}` }}>
                    {['Date', 'Flight', 'Route', 'Aircraft', 'Duration', 'Landing', 'Network', 'Sim', 'Status'].map(h => (
                      <th key={h} className="text-left px-5 py-3 text-xs font-semibold tracking-wide whitespace-nowrap"
