    ...
    <div className="min-h-screen overflow-x-hidden" style={{ background: t.bg, color: t.text }}>
      ...
      <div className="sticky top-0 z-30 px-4 sm:px-6 lg:px-8 py-4"
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 min-w-0">
            <Link to="/dashboard" className="flex items-center gap-2 text-sm transition-all duration-200 whitespace-nowrap"
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="font-bold text-base truncate" style={{ color: t.text }}>Realistic Flight Operations</span>
            </div>
          </div>
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button onClick={() => setView('mybookings')}
              className="px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 relative whitespace-nowrap"
              style={{
        ...
        {view === 'browse' && (
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-6">
              <div className="flex-1 min-w-0 flex items-center gap-2 px-4 py-3 rounded-xl"
              ...
              <div className="flex gap-2 flex-wrap">
                <button onClick={() => setNetworkFilter('')}
                  className="px-3 sm:px-4 py-3 rounded-xl text-xs font-semibold transition-all duration-200 whitespace-nowrap"
                  style={{
              ...
              <div className="px-4 py-3 rounded-xl text-sm whitespace-nowrap" style={{ background: t.card, border: `1px solid ${t.border}`, color: t.textSub }}>
                    ...
                    <div key={flight.id}
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <span className="text-sm font-bold font-mono truncate" style={{ color: '#c0121e' }}>
                            {flight.flightNumber}
                          </span>
                        </div>
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className="text-center flex-shrink-0">
                          <div className="text-xl sm:text-2xl font-bold" style={{ color: t.text }}>{flight.depIcao}</div>
                          <div className="text-xs mt-0.5 truncate max-w-[70px] sm:max-w-[80px]" style={{ color: t.textSub }}>{flight.depName}</div>
                        </div>
                        <div className="flex-1 flex flex-col items-center gap-1 min-w-0">
                          ...
                          <div className="text-xs whitespace-nowrap" style={{ color: t.textMuted }}>{flight.distance} nm</div>
                        </div>
                        <div className="text-center flex-shrink-0">
                          <div className="text-xl sm:text-2xl font-bold" style={{ color: t.text }}>{flight.arrIcao}</div>
                          <div className="text-xs mt-0.5 truncate max-w-[70px] sm:max-w-[80px]" style={{ color: t.textSub }}>{flight.arrName}</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-3">
                        ...
                        <div className="flex items-center gap-1.5 justify-end">
                          <Radio size={12} style={{ color: t.textMuted, flexShrink: 0 }} />
                          <span className="text-xs font-semibold truncate" style={{ color: t.textSub }}>
                            {flight.network}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-3" style={{ borderTop: `1px solid ${t.border}` }}>
                        <div className="flex items-center gap-1.5 min-w-0">
                          <Navigation size={12} style={{ color: t.textMuted, flexShrink: 0 }} />
                          <span className="text-xs truncate" style={{ color: t.textSub }}>
                        ...
                        {flight.status === 'AVAILABLE' && (
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <span className="text-xs font-semibold whitespace-nowrap" style={{ color: '#c0121e' }}>Book</span>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          <div className="space-y-4">
            {myBookings.length === 0 ? (
              ...
              myBookings.map((booking: any, i) => {
                ...
                return (
                  <div key={booking.id}
                    className="p-4 sm:p-5 rounded-2xl transition-all duration-200 hover:scale-[1.01]"
                    style={{ background: t.card, border: `1px solid ${t.border}` }}>
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                      <div className="flex-1 w-full min-w-0">
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          <div className="text-center flex-shrink-0">
                            <div className="text-lg sm:text-xl font-bold" style={{ color: t.text }}>{booking.depIcao}</div>
                            <div className="text-xs truncate max-w-[60px] sm:max-w-none" style={{ color: t.textSub }}>{booking.depName}</div>
                          </div>
                          <ArrowRight size={16} style={{ color: t.textMuted, flexShrink: 0 }} />
                          <div className="text-center flex-shrink-0">
                            <div className="text-lg sm:text-xl font-bold" style={{ color: t.text }}>{booking.arrIcao}</div>
                            <div className="text-xs truncate max-w-[60px] sm:max-w-none" style={{ color: t.textSub }}>{booking.arrName}</div>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-row sm:flex-col gap-2 flex-shrink-0 w-full sm:w-auto">
                        <button onClick={() => navigate(`/booking/realistic/${booking.id}`)}
                          className="flex-1 sm:flex-initial px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-200"
      ...
      {selectedFlight && (
        <div
          ...
          <div
            className="w-full max-w-lg rounded-2xl flex flex-col transition-all duration-200"
            style={{ background: isDark ? '#141414' : '#ffffff', border: `1px solid ${t.border}`, maxHeight: '90vh' }}>

            {/* Modal header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-4" style={{ borderBottom: `1px solid ${t.border}` }}>
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="font-bold text-sm truncate" style={{ color: t.text }}>
              ...
              <button onClick={() => setSelectedFlight(null)}
                className="p-2 rounded-xl transition-all duration-200 flex-shrink-0" style={{ color: t.textMuted }}
              ...
              <div className="px-4 sm:px-6 py-5 space-y-5 overflow-y-auto flex-1">
                ...
                <div className="p-4 rounded-xl" style={{ background: t.navActive, border: '1px solid rgba(192,18,30,0.1)' }}>
                  <div className="flex items-center justify-between mb-3 gap-2">
                    <div className="text-center flex-shrink-0">
                      <div className="text-xl sm:text-2xl font-bold" style={{ color: t.text }}>{selectedFlight.depIcao}</div>
                      <div className="text-xs truncate max-w-[70px] sm:max-w-none" style={{ color: t.textSub }}>{selectedFlight.depName}</div>
                    </div>
                    <div className="flex flex-col items-center gap-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <div className="w-8 sm:w-12 h-px" style={{ background: 'rgba(192,18,30,0.3)' }} />
                        <Plane size={14} style={{ color: '#c0121e' }} />
                        <div className="w-8 sm:w-12 h-px" style={{ background: 'rgba(192,18,30,0.3)' }} />
                      </div>
                      <div className="text-xs whitespace-nowrap" style={{ color: t.textMuted }}>{selectedFlight.distance} nm</div>
                    </div>
                    <div className="text-center flex-shrink-0">
                      <div className="text-xl sm:text-2xl font-bold" style={{ color: t.text }}>{selectedFlight.arrIcao}</div>
                      <div className="text-xs truncate max-w-[70px] sm:max-w-none" style={{ color: t.textSub }}>{selectedFlight.arrName}</div>
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-1 sm:gap-2 pt-3" style={{ borderTop: '1px solid rgba(192,18,30,0.1)' }}>
                    <div className="text-center">
                      <div className="text-xs font-semibold truncate" style={{ color: t.text }}>{selectedFlight.offBlock}</div>
                      <div className="text-xs" style={{ color: t.textMuted }}>Off-Block</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xs font-semibold truncate" style={{ color: t.text }}>{selectedFlight.onBlock}</div>
                      <div className="text-xs" style={{ color: t.textMuted }}>On-Block</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xs font-semibold truncate" style={{ color: t.text }}>{selectedFlight.estimatedFlightTime}</div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl" style={{ background: t.input, border: `1px solid ${t.border}` }}>
                    ...
                    <span className="text-sm font-bold truncate block" style={{ color: '#8b5cf6' }}>{selectedFlight.network}</span>
                  </div>
                  <div className="p-3 rounded-xl" style={{ background: t.input, border: `1px solid ${t.border}` }}>
                    <div className="flex items-center gap-2 mb-1">
                      <DollarSign size={12} style={{ color: '#f59e0b' }} />
                    ...
                    <span className="text-sm font-bold truncate block" style={{ color: '#f59e0b' }}>{calcEarnings(selectedFlight)}</span>
                  </div>
                </div>
                ...
                {/* Booking message */}
                {bookingMsg && (
                  <div className="px-4 py-3 rounded-xl text-xs break-words"
