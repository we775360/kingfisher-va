            ...
            {isUpcoming && (
              ...
              >
                ...
                <div className="p-6 space-y-5">
                  ...
                  {/* IVAO Filming Note */}
                  <div>
                    <div className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: t.textMuted }}>IVAO Flight Plan Filing</div>
                    <div className="space-y-2">
                      <div className="flex items-start gap-3 px-4 py-3 rounded-xl" style={{ background: t.input }}>
                        <Info size={14} style={{ color: '#3b82f6', marginTop: 2, flexShrink: 0 }} />
                        <div className="text-[11px] leading-relaxed" style={{ color: t.textSub }}>
                          When filing your flight plan on IVAO, add the following remark code to identify your flight with Kingfisher Virtual Airlines:
                        </div>
                      </div>
                      <div
