        ...
        <div className="rounded-3xl p-6 sm:p-8 md:p-10 backdrop-blur-xl bg-white/70 border border-white/40 shadow-xl shadow-slate-200/50 transition-all duration-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link
                to="/forgot-password"
                className="text-xs font-semibold text-red-600 hover:text-red-700 transition-all duration-200"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-slate-400 text-xs font-medium mt-6">
            ...
            <Link to="/register" className="text-red-600 hover:text-red-700 font-bold transition-all duration-200">
              Register for free
            </Link>
          </p>
        </div>
