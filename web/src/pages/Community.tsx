      ...
      <div className="sticky top-0 z-30 px-6 py-4"
        ...
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <MessageCircle size={16} style={{ color: '#c0121e' }} />
            <span className="font-bold text-base" style={{ color: t.text }}>Community</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-6 space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="relative z-10 px-8 py-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Join the Kingfisher VA Community</h2>
          ...
          <div className="divide-y" style={{ borderColor: t.border }}>
            {channels.map((ch, i) => (
              <motion.div key={ch.name}
                ...
                <div>
                  <div className="text-sm font-semibold font-mono" style={{ color: '#5865F2' }}>{ch.name}</div>
                  <div className="text-xs mt-0.5" style={{ color: t.textSub }}>{ch.desc}</div>
                </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <motion.a key={contact.label}
              ...
              <div>
                <div className="text-sm font-bold mb-0.5" style={{ color: t.text }}>{contact.label}</div>
                <div className="text-xs font-mono mb-1" style={{ color: contact.color }}>{contact.value}</div>
                <div className="text-xs" style={{ color: t.textMuted }}>{contact.desc}</div>
              </div>
