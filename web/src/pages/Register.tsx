  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 py-8 overflow-hidden bg-slate-50">
      ...
      >
        ...
        <div className="rounded-3xl p-8 md:p-10 backdrop-blur-xl bg-white/70 border border-white/40 shadow-xl shadow-slate-200/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl text-white font-bold text-sm tracking-wide transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg mt-2"
              style={{
        ...
        <p className="text-center text-slate-400 text-[10px] font-medium mt-5 leading-relaxed">
