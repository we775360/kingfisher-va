import { Plane, Activity, Briefcase, MapIcon, Settings, LogOut, FileText } from 'lucide-react'
...
export function Sidebar({ activeTab, onTabChange, onLogout }: SidebarProps) {
  return (
    <div className="w-[64px] bg-[#0d0d0d] border-r border-neutral-800/40 flex flex-col items-center py-5 gap-5 z-30 shrink-0">
      <div className="p-2 bg-gradient-to-br from-kf-red to-red-800 rounded-xl shadow-lg shadow-kf-red/20">
      ...
      <nav className="flex-1 flex flex-col gap-0.5">
        {NAV_ITEMS.map((item) => (
          ...
          >
            ...
            {activeTab === item.id && (
              <div className="absolute -left-[1px] top-1/2 -translate-y-1/2 w-0.5 h-5 bg-kf-red rounded-r-full shadow-[0_0_8px_rgba(192,18,30,0.5)]" />
            )}
          </button>
        ))}
      </nav>
